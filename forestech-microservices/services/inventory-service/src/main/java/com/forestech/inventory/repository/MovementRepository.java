...
public interface MovementRepository extends JpaRepository<Movement, String> {
        ...
        @Lock(LockModeType.PESSIMISTIC_WRITE)
        Optional<Movement> findTopByProductIdAndMovementTypeAndRemainingQuantityGreaterThanOrderByCreatedAtAsc(
                        String productId, Movement.MovementType movementType, BigDecimal remainingQuantity);
        ...
        // Obtener suma ponderada (remaining_quantity * unit_price) para calcular
        // promedio
        ...
        // Buscar entradas de un producto ordenadas por fecha DESC (para recomposición
        // FIFO inversa)

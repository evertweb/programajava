...
public class ProductManagerGUI extends JFrame {
     ...
     */
    public ProductManagerGUI(ProductServices productServices) {
    ...
    private void crearPanelFormulario() {
        ...
        panelFormulario.setBackground(ColorScheme.BACKGROUND_PANEL);
        panelFormulario.setBorder(BorderFactory.createTitledBorder("Agregar Nuevo Producto"));

        panelFormulario.add(createFormLabel("Nombre:"));
        txtNombre = new JTextField(20);
        panelFormulario.add(txtNombre);

        panelFormulario.add(createFormLabel("Precio (COP):"));
        txtPrecio = new JTextField(12);
        panelFormulario.add(txtPrecio);

        panelFormulario.add(createFormLabel("Unidad:"));
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            new ProductManagerGUI(factory.getProductServices());
        });

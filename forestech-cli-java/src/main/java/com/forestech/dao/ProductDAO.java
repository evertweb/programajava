...
public class ProductDAO implements GenericDAO<Product> {
    ...
    public void insert(Product product) throws SQLException {
        String sql = "INSERT INTO oil_products (id, nombre, categoria, precio_unitario) VALUES (?, ?, ?, ?)";
    ...
    public Optional<Product> findById(String id) throws SQLException {
        String sql = "SELECT id, nombre, categoria, precio_unitario FROM oil_products WHERE id = ?";
    ...
    public List<Product> findAll() throws SQLException {
        String sql = "SELECT id, nombre, categoria, precio_unitario FROM oil_products ORDER BY nombre";
    ...
    public void update(Product product) throws SQLException {
        String sql = "UPDATE oil_products SET nombre = ?, categoria = ?, precio_unitario = ? WHERE id = ?";
    ...
    public List<Product> findByName(String name) throws SQLException {
        String sql = "SELECT id, nombre, categoria, precio_unitario FROM oil_products " +
    ...
    public List<Product> findByMeasurementUnit(MeasurementUnit unit) throws SQLException {
        String sql = "SELECT id, nombre, categoria, precio_unitario FROM oil_products " +
                    "WHERE categoria = ? ORDER BY nombre";
        List<Product> products = new ArrayList<>();
    ...
    private Product mapResultSetToProduct(ResultSet rs) throws SQLException {
        return new Product(
            rs.getString("id"),
            rs.getString("nombre"),
            MeasurementUnit.fromCode(rs.getString("categoria")),
